...
import { updatePlanetNameTop } from './PlanetNameTop.js'
...
class Planet {
  ...
  renderUI(){
    ...
    infoBox.innerHTML = "Planet<br><div id='planetName'></div><br><div id='instructions'>H - Show/Hide UI</div>";
  ...
  updatePlanetName() {
    ...
    if (planetName != null) {
      planetName.innerHTML = this.seedString + " (IQ: " + this.iq + ")";
    }

    let planetNameMobile = document.getElementById("planetNameMobile");
    if (planetNameMobile != null) {
      planetNameMobile.innerHTML = this.seedString + " (IQ: " + this.iq + ")";
    }
    updatePlanetNameTop(this.seedString, this.iq);
  }
  ...
  loadSeedFromURL() {
    ...
    if (this.seedString) {
      ...
      this.iq = Math.floor(Math.random() * (300 - 10 + 1)) + 10;
      updatePlanetNameTop(this.seedString, this.iq);
      this.regenerate();
    } else {
  ...
  // Randomize IQ for each new planet
  this.iq = Math.floor(Math.random() * (300 - 10 + 1)) + 10;
